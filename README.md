...
- **Medir → Competencia** · Marcas que vigilas: guardas su página de la Biblioteca de anuncios y Claude deja ahí sus anuncios activos (`/competencia`). Por marca: cuántos corren, antigüedad media, cuáles llevan más tiempo sin apagarse (sus ganadores, con enlace para guardarlos con Nova Swipe) y qué ángulos, formatos y ofertas repiten según lo que ya tengas en la Biblioteca.
...
La clave del canal de Claude (`SYNC_TOKEN`) se puede generar desde **Ajustes → Conexión con Claude** y queda guardada en la base, o definirse como variable de entorno, que manda sobre la otra.
